...
const capabilitySchema = z.object({
  version: z.literal(1), pluginID: z.literal('chatgpt2api'), resourceURL: z.url(),
...
export function readHostRequest(): HostRequest | undefined {
  try {
    ...
    if (!parsed.success || parsed.data.resourceURL !== window.location.href
      || window.location.pathname !== '/v0/resource/plugins/chatgpt2api/index' || window.location.search || window.location.hash) return;
